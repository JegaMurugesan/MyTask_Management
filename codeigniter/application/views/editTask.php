...
<div class='container'>
<form class="form-horizontal" method='post' action="<?php echo base_url('index.php/welcome/update');?>">
  <fieldset>
    <legend>Task Updation</legend>
	
    <div class="form-group">
	<input type="hidden" class="form-control" id="id" name='id' value='<?php echo $id;?>' >
      <label for="inputEmail" class="col-lg-2 control-label">User Name</label>
      <div class="col-lg-10">
        <input type="text" class="form-control" id="uname" name='uname' value='<?php echo $name;?>' placeholder="User Name">
      </div>
    </div>
   <!-- <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <textarea class="form-control" rows="2" id="desc" name='desc' value='<?php echo $description;?>'><?php echo $description;?></textarea>
